    ...
    return (
        <>
            <form>
                ...
                <h1 style={{margin:"40px 0 60px 0"}}><span>Оформление заказа</span></h1>
                        <div className="zakascontainer_1">
                            <div className='aftarizatsiyafle132' style={{ display: "flex", marginTop: "2%", flexDirection: "column", gap: "20px" }}>
                                <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                                    <h4>ФИО / Организация</h4>
                                    <input style={{ width: "300px" }} required className='inputaftarizatsiya' type="text" name='next' placeholder='Иванов Иван Иванович' />
                                </div>
                                <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                                    <h4>ИНН (не обязательно)</h4>
                                    <div><input style={{ width: "300px" }} required className='inputaftarizatsiya' type="text" name='innane' placeholder='0000000000' /></div>
                                </div>
                            </div>
                            <div className='aftarizatsiyafle1' style={{ display: "flex", marginTop: "2%", justifyContent: "space-between", width: "310px" }}>
                                <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                                    <h4>Телефон</h4>
                                    <input style={{ width: "135px" }} required className='inputaftarizatsiya' type="text" name='next' placeholder='+7 000 000 00 00' />
                                </div>
                                <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                                    <h4>Почта</h4>
                                    <div><input style={{ width: "135px" }} required className='inputaftarizatsiya' type="text" name='innane' placeholder='ex@mail.com' /></div>
                                </div>
                            </div>
                        </div>
                        <form>
                        ...
                        <div className='zakascontainer_1' style={{ display: "flex", marginTop: "2%", flexDirection: "column", gap: "20px" }}>
                            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                                <h4>Адрес</h4>
                                <input style={{ width: "300px" }} className='inputaftarizatsiya' required type="text" name='next' placeholder='Москва, ул. Пушкина д. 32 корп. 3' />
                            </div>
                            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                                <h4>Адрес</h4>
                                <textarea style={{ border: "none", width: "290px", padding: "10px" }} required className="inputaftarizatsiya" name="" id="" cols="30" rows="10"></textarea>
                            </div>
                        </div>
                    </div>
                    <div className="zakascontainer_box2">
                        ...
                        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%", flexWrap: "wrap" }}>
                            <NavLink to={"/zakasta"}><button style={{ boxShadow: "0px 9px 25px -4px #487B6C80", background: "#10BB87", border: "none", color: "white", padding: "15px 30px", borderRadius: "10px", margin: "20px 0 0 0", fontSize: "16px" }}>Отправить заказ</button></NavLink>
                            <p style={{ width: "250px" }}>С вами свяжется специалист для уточнения заказа и оплаты.</p>
                        </div>
                    </div>
                </div>
            </form>
